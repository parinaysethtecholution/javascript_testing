 ...
 *
 * @param {string} file - The file path for which to find forks.
 ...
 * @param {string} renderer - The renderer for which to add the fork.
 * @param {string} file - The file path for which to add the fork.
 */
 ...
 *
 * @param {string} renderer - The renderer for which to write the config.
 * @param {Object} rendererInfo - The renderer information object.
 * @param {boolean} isServerSupported - Whether the renderer is server-supported.
 * @param {boolean} isFlightSupported - Whether the renderer is Flight-supported.
 */
function writeConfig(
  ...
  // Determine Flight support based on server support and isFlightSupported value
  isFlightSupported =
  ...
  // Add ignored paths for forks not present in the forks map
