...
// Read the config template from the file
 ...
 * @param {boolean} isServerSupported - Whether server rendering is supported.
 * @param {boolean} isFlightSupported - Whether Flight rendering is supported.
 */
function writeConfig(
  ...
  // Determine Flight support based on server support and configuration
  isFlightSupported =
  ...
  // Add remaining forks to ignored paths
...
// Generate Flow configs for each Flow-typed renderer
