...
/**
 * Find forks for a given file and update the allForks set and forkedFiles map.
 *
...
/**
 * Write the Flow config for the given renderer and its supported configurations.
 *
 * @param {string} renderer - The renderer name.
...
// Generate Flow configs for Flow-typed renderers
