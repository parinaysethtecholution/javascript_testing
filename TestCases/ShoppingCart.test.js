...
describe('ShoppingCart', () => {
  ...
  describe('displayItems', () => {
    it('should log the items in the cart', () => {
      const item1 = new Item('Laptop', 1000);
      const item2 = new Item('Phone', 800);
      const item3 = new Item('Headphones', 100);
      cart.addItem(item1);
      ...
      console.log = jest.fn();
      cart.displayItems();
      expect(console.log).toHaveBeenCalledWith('Shopping Cart Items:');
      expect(console.log).toHaveBeenCalledWith('1. Laptop - $$1000');
      expect(console.log).toHaveBeenCalledWith('2. Phone - $$800');
      expect(console.log).toHaveBeenCalledWith('3. Headphones - $$100');
    });
  });
