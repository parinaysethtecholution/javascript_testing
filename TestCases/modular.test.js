...
describe('returnTaskChats function', () => {
  it('should return an array of task chat objects with the correct properties', () => {
    const taskChatData = {
      ...
      chat2: {
        id: 2,
        question: 'Can you provide more details on the project requirements?',
        response: 'The project requirements are as follows...',
...
describe('returnCity function', () => {
  it('should return the city name from a string', () => {
    ...
    const str3 = 'It's a beautiful day in the park.';
